...
function myhpUpdater (autoUpdate) {
    var updateURL;
    if(prefUpdateChannel=="release"){updateURL="https://raw.github.com/Habboeasy/userscript-1/release/";}else if(prefUpdateChannel=="beta"){updateURL="https://raw.github.com/Habboeasy/userscript-1/beta/";}else{updateURL=prefUpdateCustomChannel;}
